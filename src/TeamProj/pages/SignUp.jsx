      ...
      <div className='md:w-[50%] w-full lg:px-[151px] md:px-[60px] px-[16px] py-[56px]'>
        ...
        <form className='w-full mt-[36px] flex flex-col gap-[24px]' onSubmit={handleSubmit}>
          <label className="flex flex-col gap-[20px] w-full">
            ...
            <input className={`border ${errorFname ? 'border-[#F83F23]': 'border-gray-300'} rounded-[8px] py-[10px] px-[14px]`}  type="text" placeholder="Enter your first name" onChange={(e) => setFname(e.target.value)} />
          ...
          <label className="flex flex-col gap-[20px] w-full">
            ...
            <input className={`border ${errorLname ? 'border-[#F83F23]': 'border-gray-300'} rounded-[8px] py-[10px] px-[14px]`}  type="text" placeholder="Enter your last name" onChange={(e) => setLname(e.target.value)} />
